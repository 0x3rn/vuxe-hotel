...
export default function HomePage() {
  return (
    <div className="flex flex-col w-full">
      {/* Hero Section */}
      <section className="relative h-[90vh] w-full flex items-center justify-center bg-stone-50">
        <div 
        ...
        <motion.div 
          ...
          animate="visible" 
          variants={fadeInUp}
          className="relative z-10 text-center text-white space-y-6 max-w-4xl px-6"
        >
          <h1 className="text-5xl md:text-7xl font-serif font-bold drop-shadow-lg tracking-wide">
        ...
        <motion.div 
          ...
          className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-[95%] max-w-5xl bg-white shadow-2xl p-8 rounded-lg text-foreground flex flex-col md:flex-row gap-6 items-end border border-zinc-100 z-20"
        >
          <div className="flex-1 w-full">
            <label className="block text-xs uppercase tracking-wider text-muted-foreground mb-3 font-medium">Check In</label>
            <input type="date" className="w-full border-b border-border pb-2 focus:outline-none focus:border-primary bg-transparent text-sm" />
          </div>
          <div className="flex-1 w-full">
          ...
          <div className="flex-1 w-full">
            ...
            <select className="w-full border-b border-border pb-2 focus:outline-none focus:border-primary bg-transparent text-sm">
          ...
          <button className="bg-primary text-primary-foreground px-10 py-4 rounded uppercase text-sm tracking-widest font-semibold hover:bg-primary/90 transition-colors w-full md:w-auto h-full">
            Check Availability
          </button>
        </motion.div>
      </section>
      ...
      <section className="py-24 bg-white">
        ...
        >
          ...
          <h3 className="text-4xl md:text-5xl font-serif mb-8 text-balance text-zinc-900 leading-tight">Where Every Moment Becomes a Cherished Memory</h3>
      ...
      <section className="py-24 bg-[#FAFAFA]">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-zinc-900">Our Signature Suites</h3>
          </motion.div>
          ...
          >
            {/* Suite 1 */}
            <motion.div variants={fadeInUp} className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-8 text-center border border-t-0 border-zinc-100">
                ...
                <p className="text-zinc-500 text-sm mb-6 line-clamp-3">An opulent sanctuary suspended in the sky. Featuring panoramic city and ocean views, a private infinity plunge pool, and a dedicated 24-hour butler.</p>
                <p className="text-primary font-medium mb-6">From $2,500 / night</p>
                <button className="border border-zinc-300 text-zinc-700 px-6 py-2 rounded uppercase text-xs tracking-widest hover:bg-zinc-900 hover:text-white hover:border-zinc-900 transition-colors">
                  Discover More
                </button>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-8 text-center border border-t-0 border-zinc-100">
                ...
                <p className="text-zinc-500 text-sm mb-6 line-clamp-3">Awaken to the gentle sound of waves and breathtaking azure horizons. This expansive suite offers a private wraparound balcony and deep soaking tub.</p>
            ...
            <motion.div variants={fadeInUp} className="group bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-8 text-center border border-t-0 border-zinc-100">
                ...
                <p className="text-zinc-500 text-sm mb-6 line-clamp-3">A secluded haven designed for ultimate privacy and exclusivity. Nestled in lush tropical gardens with a private courtyard and heated pool.</p>
      ...
      <section className="py-24 bg-white overflow-hidden">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl font-serif text-zinc-900">The Pinnacle of Elegance</h3>
          </motion.div>
          ...
          <div className="space-y-32">
            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              >
                <div className="aspect-[4/3] rounded-lg overflow-hidden shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1414235077428-33898bd12284?auto=format&fit=crop&w=1000&q=80" alt="Michelin-Star Dining" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
              </motion.div>
              <motion.div 
                initial={{ opacity: 0, x: 50 }}
              ...
              >
                <h4 className="text-3xl font-serif text-zinc-900">Michelin-Star Dining</h4>
                <p className="text-zinc-500 leading-relaxed text-lg">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-16">
              ...
              >
                <h4 className="text-3xl font-serif text-zinc-900">Award-Winning Spa & Wellness</h4>
                <p className="text-zinc-500 leading-relaxed text-lg">
            ...
            <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              <motion.div 
                ...
                className="w-full md:w-1/2 space-y-6"
              >
                <h4 className="text-3xl font-serif text-zinc-900">Private Chauffeur & Heli-pad</h4>
                <p className="text-zinc-500 leading-relaxed text-lg">
